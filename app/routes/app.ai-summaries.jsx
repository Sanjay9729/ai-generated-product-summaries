...
export default function AISummariesPage() {
  const { products, totalProducts, aiSummaries, totalSummaries, error, autoGenerated, totalPending, wasCacheCleared } = useLoaderData();
  ...
  return (
    <s-page heading="AI Product Summaries">
      <s-section heading="Overview">
        ...
        >
          <s-stack direction="block" gap="tight">
            <s-text variant="headingSm">🤖 Fully Automatic AI Summary Generation</s-text>
            ...
            <s-text variant="bodySm">
              ✓ Auto-generated during product sync<br />
              ✓ Auto-generated when new products are created (via webhooks)<br />
              ✓ Auto-generated when viewing products without summaries<br />
        ...
        {autoGenerated > 0 && (
          ...
          >
            <s-stack direction="block" gap="tight">
              <s-text variant="headingSm">🤖 Auto-Generated AI Summaries</s-text>
              <s-text variant="bodySm">
        ...
        {wasCacheCleared && (
          ...
          >
            <s-stack direction="block" gap="tight">
              <s-text variant="headingSm">🔄 Cache Cleared - Regenerating AI Summaries</s-text>
              <s-text variant="bodySm">
